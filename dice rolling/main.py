...
def dice_rolling():
	...
	if dice_value == 1:
		my_img_1_label = Label(image=img_1).place(x=150,y=115)




	elif dice_value == 2 :
		my_img_2_label = Label(image=img_2).place(x=150,y=115)



	elif dice_value == 3:
		my_img_3_label = Label(image=img_3).place(x=150,y=115)



	elif dice_value == 4 :
		my_img_4_label = Label(image=img_4).place(x=150,y=115)



	elif dice_value == 5:
		my_img_5_label = Label(image=img_5).place(x=150,y=115)


	elif dice_value == 6 :
		my_img_6_label = Label(image=img_6).place(x=150,y=115)
...
dice_rolling_button = Button(root, text='Roll Here',command=dice_rolling(), bg='burlywood1',borderwidth=2,relief="solid",padx=20.5,pady=4,font=("arial Black", 10)).place(x=379.5, y=346)
